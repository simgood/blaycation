...
<header class="center panel-500 d-b relative" style="background:url('<?php echo $imgsrc[0] ?>')no-repeat center center fixed;background-size:cover;">
	<div class="cover bg-tr-dark fill absolute">
		<div class="p-t-xxl text-white w80">
